...
function getStoredSidebarState(): boolean {
  ...
  try {
    ...
    if (stored === null) return true; // Default to expanded if not set
    return stored === 'true';
  } catch (error) {
...
>(
  (
    ...
    // Initialize state from localStorage, falling back to defaultOpen
    const [_open, _setOpen] = React.useState(() => {
      // Only read from storage on client side
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        // Save state to localStorage and cookie

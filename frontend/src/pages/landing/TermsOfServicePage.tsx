        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-12 rounded-xl bg-card p-6 shadow-sm sm:p-8">
            <div className="mb-4 flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-accent dark:bg-primary/20">
                <FileText className="h-5 w-5 text-primary dark:text-primary/70" />
              </div>
          ...
          <section className="rounded-xl bg-accent p-6 dark:bg-primary/10 sm:p-8">
            <div className="mb-4 flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-accent dark:bg-primary/20">
                <Mail className="h-5 w-5 text-primary dark:text-primary/70" />
              </div>
            ...
            <div className="mt-4 space-y-2 text-foreground/80">
              ...
              <p>
                ...
                <a
                  ...
                  className="text-primary hover:underline dark:text-primary/70"
                >

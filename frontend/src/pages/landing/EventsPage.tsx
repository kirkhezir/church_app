    ...
    <PublicLayout>
      ...
      <div ref={revealRef}>
        ...
        {featuredEvents.length > 0 && (
          <div className="reveal bg-muted py-8">
            <div className="mx-auto max-w-6xl px-4 sm:px-6">
              <h2 className="mb-4 text-balance text-lg font-semibold text-foreground">
        ...
        <div className="reveal mx-auto max-w-6xl px-4 py-8 sm:px-6">
                    ...
                    <CardContent className="p-5">
                      ...
                      {event.rsvpRequired && (
                        <div className="mt-3 flex items-center justify-between">
                          <span className="flex items-center gap-1 text-sm tabular-nums text-emerald-600">
          ...
          {/* Add to Calendar CTA */}
          <div className="reveal mt-12 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 p-8 text-center text-white">
